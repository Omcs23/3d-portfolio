  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500 leading-relaxed'>
        ...
        <p>
          Alongside my degree, I hold professional certifications in <strong>Cybersecurity (Coursera / Google)</strong>, <strong>Generative AI & DevOps (Oracle OCI 2025)</strong>, and <strong>Java & MERN Stack (Infosys Springboard)</strong>. I am also an active competitive programmer on <strong>LeetCode</strong> and <strong>Codeforces</strong>.
        </p>
      </div>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>
            A summary of my academic journey at GLA University alongside my professional certifications and technical achievements:
          </p>
        </div>
